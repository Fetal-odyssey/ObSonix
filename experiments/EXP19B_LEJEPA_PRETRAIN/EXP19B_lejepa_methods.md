# Pre-entrainement LeJEPA ViT-S/16 (in-domain) - EXP19B_LEJEPA_PRETRAIN

## Contexte
Aucun checkpoint ViT-S/16 LeJEPA officiel n'est publie : le depot officiel
...
## Methode
- Backbone : ViT-S/16 (timm vit_small_patch16_224, 384-dim).
...
## Resultats
- Epochs : 100 ; perte LeJEPA finale : 0.0725
- Artefact : weights/LeJEPA/lejepa_vits16.pth (backbone), init de EXP-14 (DAPT).
